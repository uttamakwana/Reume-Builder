    ...
    return (
      <>
        ...
        <div className="mt-10">
          ...
          >
            <div className="p-4">
              <h3 className="text-2xl font-extrabold  ">Education Details</h3>
            </div>
            <div className="p-4">
            ...
            {this.state.isDiploma ? (
              <>
                <div className="p-4">
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-12">
                    <div className="md:col-span-3">
                      <label className="block mb-2 font-medium  " htmlFor="ssc">
                    ...
                    <div className="md:col-span-3">
                      <label className="block mb-2 font-medium  " htmlFor="hsc">
